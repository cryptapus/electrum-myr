...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.setWindowTitle("Myriadcoin Electrum")
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Myriadcoin Electrum %s - %s %s" % (electrum_version, amount, unit))
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        ...
        self.setWindowTitle("Myriadcoin Electrum - " + _("Receive Myriadcoin payment"))
...
class MiniActuator:
    ...
    def waiting_dialog(self, f):
        ...
        w = QDialog()
        w.resize(200, 70)
        w.setWindowTitle('Myriadcoin Electrum')
